...
//////////////////////////////////////////////////////////////////
    ...
    if(pindex->nHeight > 5000 && !Params().GetConsensus().fPoSNoRetargeting) {
        ...
        if(pindex->nMoneySupply > (uint64_t)(1300000000ull + ((pindex->nHeight - 5000) * 1ull)) * COIN){
    ...
    try {
        ...
        while (!blkdat.eof()) {
            ...
            try {
                ...
                // But for Predix PoS we need to sync this after every block to ensure txdb is populated for
