...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Predixproject/Predix>";
    const std::string URL_WEBSITE = "<https://Predix.org>";
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                boost::filesystem::path qtumStateDir = GetDataDir() / "statePredix";
