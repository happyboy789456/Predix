...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s Predix-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Predix-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Predix transaction") + "\n" +
              "  Predix-tx [options] -create [commands]   " + _("Create hex-encoded Predix transaction") + "\n" +
              "\n";
