...
{
    const char* pszTimestamp = "Jul 28, 2018 Predix";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x000008783fc47ff600ee23a7b730ed7120916046ccd8ad7dad86980b096fc034");
        ...
        consensus.defaultAssumeValid = uint256S("0x000008783fc47ff600ee23a7b730ed7120916046ccd8ad7dad86980b096fc034"); //0
        ...
        genesis = CreateGenesisBlock(1530115200, 6316148, 0x1f00ffff, 1, 50 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000008783fc47ff600ee23a7b730ed7120916046ccd8ad7dad86980b096fc034"));
        assert(genesis.hashMerkleRoot == uint256S("0x9e3464dc83b7dad158e2924f10eac3a603378e7fff8adb33e263d6d989a5207c"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("000008783fc47ff600ee23a7b730ed7120916046ccd8ad7dad86980b096fc034"))
            ( 5000, uint256S("000025bd7f733e166d870dd7c567d32071ba148e5ca02ffd61157e5f76e13e8f"))
            ( 5001, uint256S("37e33f7e4c5e57b7c2f49758ae6f429221431f4994a1325f159dcb7b0585ba27"))
            ( 5002, uint256S("f6b3eaa757241e6f53184157480c9f9efeb8039e36275d6be1d60df8578456d8"))
            ( 5005, uint256S("306013a9cf463d1660645a75d8febddf3e50f46e3fd99344db9ab2107e2c0a77"))
        };
...
public:
    CTestNetParams() {
        ...
        consensus.nSubsidyHalvingInterval = 985500;
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("000008783fc47ff600ee23a7b730ed7120916046ccd8ad7dad86980b096fc034");
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("000008783fc47ff600ee23a7b730ed7120916046ccd8ad7dad86980b096fc034");
        ...
        genesis = CreateGenesisBlock(1530115200, 6316148, 0x1f00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("000008783fc47ff600ee23a7b730ed7120916046ccd8ad7dad86980b096fc034"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("Predix4.dynu.net", "Predix4.dynu.net", false));
