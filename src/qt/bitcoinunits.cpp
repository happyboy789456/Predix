...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PDCC");
    case mBTC: return QString("mPDCC");
    case uBTC: return QString::fromUtf8("μPDCC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Predixs");
    case mBTC: return QString("Milli-Predixs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Predixs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
